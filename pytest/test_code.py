...
def test_findDuplicates():
    ...
    result = findDuplicates(listSongs("/home/charles/Documents/RockbandTools/sZFE/"))
    assert result == expected

def test_display():
    expected = ['Goodbye Blue Sky', 'Hotel California', 'Hotel California', 'Fluttering Romance', 'Born to Run']
    result = display("/home/charles/Documents/RockbandTools/sZFE/")
    assert result == expected
...
def test_listSongs():
    ...
    result = listSongs("/home/charles/Documents/RockbandTools/sZFE/")
    assert result == expected

def test_exportCSV():
    exportCSV("/home/charles/Documents/RockbandTools/sZFE/")
    result = os.path.isfile(os.getcwd() + "/rockband_songs.csv")
    assert result == TRUE

def test_copySongs():
    copySongs("/home/charles/Documents/RockbandTools/sZFE/",os.getcwd())
